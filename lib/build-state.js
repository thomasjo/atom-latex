...
declare type StringArray = string | Array<string>

function toArray (value: StringArray): Array<string> {
...
export class BuildState {
  ...
  setCleanPatterns (value: StringArray): void {
  ...
  setEnableSynctex (value: any): void {
  ...
  setEnableShellEscape (value: any): void {
  ...
  setEnableExtendedBuildMode (value: any): void {
  ...
  setMoveResultToSourceDirectory (value: any): void {
  ...
  setShouldRebuild (value: any): void {
  ...
  getJobNames (): Array<string> {
    return this.jobStates.map((jobState: JobState) => jobState.getJobName())
  }

  setJobNames (value: StringArray): void {
