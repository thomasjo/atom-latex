...
function forwardSync (pdfView: ?Object, texPath: string, lineNumber: number): void {
...
export default class PdfViewOpener extends Opener {
  async open (filePath: string, texPath: string, lineNumber: number): Promise<void> {
    ...
    atom.workspace.open(filePath, {'split': 'right'}).then((pane: ?Object): void => forwardSync(pane, texPath, lineNumber))
  }
