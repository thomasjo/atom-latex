...
export default class Composer {
  ...
  async build() {
    ...
    const workingDirectory = this.resolveWorkingDirectory(rootFilePath);
    ...
    return new Promise(async function(resolve, reject) {
      ...
      try {
        statusCode = await builder.run(rootFilePath, workingDirectory);
  ...
  resolveWorkingDirectory(filePath) {
    ...
    const workingDirectoryMode = this.getWorkingDirectoryMode();
    switch (workingDirectoryMode) {
      case "project": return this.resolveProjectPath(filePath);
    }
  ...
  getWorkingDirectoryMode() {
    return atom.config.get("latex.workingDirectoryMode");
  }
